...
with st.sidebar:
        st.image('mg.webp')
        st.title("Animal Health")
        st.subheader("Deteksi akurat penyakit yang ada pada hewan. Ini membantu pengguna untuk dengan mudah mendeteksi penyakit dan mengidentifikasi penyebabnya.")
...
if file is None:
    ...
    # st.sidebar.error("Predictions : " + str(np.argmax(predictions)))
